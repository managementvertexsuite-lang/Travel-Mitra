    ...
    <div className="bg-white">
      ...
      <div className="relative h-96 bg-gray-100 flex items-center justify-center overflow-hidden">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center">
          <h1 className="text-5xl font-bold text-dark mb-2 text-center">{data.title}</h1>
          <p className="text-2xl text-muted">{data.subtitle}</p>
        </div>

        {/* Back Button */}
        <button
          onClick={onBack}
          className="absolute top-6 left-6 bg-white text-primary px-4 py-3 rounded-full hover:bg-gray-100 transition-all flex items-center gap-2 font-semibold shadow-md hover:shadow-lg"
        >
          <ChevronLeft size={20} />
          Back
        </button>
